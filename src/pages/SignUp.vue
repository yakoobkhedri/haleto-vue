    ...
    <aos-vue>
      ...
      <div class="row mx-0">
        ...
        <div class="col-lg-5 position-relative bg-login h-100vh h-lg-auto overflow-auto">
          ...
          <!-- shape -->
          <svg class="position-absolute bottom-0 start-0 -z-0 d-lg-none" width="159" height="172" viewBox="0 0 159 172"
          ...
          <!--  -->
          <form class="max-w-340 mx-auto my-5 pb-5 position-relative">
            ...
            <h4 class="font-bold fs-18 text-center mt-3 text-lg-white">لطفا جهت ثبت نام اطلاعات خود را تکمیل کنید</h4>
            <div class="mt-5 text-lg-white">
              ...
              <div class="d-flex h-48 align-items-stretch gap-1 rounded-4 border mb-3">
                <input class="placeholder-lg-white outline-none bg-transparent w-100 border-0 fw-bold fs-12 px-3"
              ...
              <label class="d-flex align-items-center gap-2 cursor-pointer">
                ...
                <p class="mb-0 mt-1 text-main fs-14 fw-bold">قوانین و مقررات</p>
              </label>
