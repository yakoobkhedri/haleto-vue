      ...
      <div class="row mx-0">
        ...
        <div class="col-lg-5 position-relative bg-login h-100vh h-lg-auto">
          ...
          <form class="max-w-340 mx-auto my-5 py-5 position-relative">
            ...
            <h4 class="font-bold fs-20 text-center mt-3 text-lg-white">خوش آمدید</h4>
            <div
              class="rounded-4 bg-gray-transparent h-48 border d-flex align-items-center gap-2 px-3 fs-14 fw-bold mt-4">
            ...
            <div class="mt-3">
              ...
              <a class="text-lg-white text-dark fs-14">رمز عبور خود را فراموش کرده اید؟</a>
            </div>
            <div class="d-flex align-items-center gap-3 mt-3 position-relative">
              <div
                class="rounded-4 bg-gray-transparent flex-shrink-0 w-100 h-48 border d-flex align-items-center gap-2 fs-14 fw-bold">
                ...
                <div
                  ...
                  55930
                  <svg class="cursor-pointer flex-shrink-0 d-sm-none" width="28" height="32" viewBox="0 0 28 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path class="stroke-lg-white" d="M24.2391 13.3748L21.6723 14.0665C21.0736 12.2561 19.8539 10.6056 18.0624 9.56549C14.1685 7.30467 9.18761 8.6483 6.94116 12.5612L6.69221 12.9948L7.12462 13.2459L8.66607 14.1408L6.56617 14.6718L6.55869 14.6737L6.55127 14.6758L4.2972 15.3209C4.1949 15.3475 4.05814 15.3303 3.92625 15.2537C3.79312 15.1764 3.7096 15.0646 3.6821 14.9614L3.06499 12.6453L2.5082 10.5556L4.02339 11.4353L4.4558 11.6864L4.70474 11.2528C7.65392 6.11587 14.2147 4.31387 19.3618 7.30228C21.782 8.70748 23.4391 10.908 24.2391 13.3748Z" fill="#6CB771" stroke="#F9F9F9"/>
                    <path class="stroke-lg-white" d="M3.76091 18.6252L6.32769 17.9335C6.92642 19.7439 8.14609 21.3944 9.93756 22.4345C13.8315 24.6953 18.8124 23.3517 21.0588 19.4388L21.3078 19.0052L20.8754 18.7541L19.3339 17.8592L21.4338 17.3282L21.4413 17.3263L21.4487 17.3242L23.7028 16.6791C23.8051 16.6525 23.9419 16.6697 24.0737 16.7463C24.2069 16.8236 24.2904 16.9354 24.3179 17.0386L24.935 19.3547L25.4918 21.4444L23.9766 20.5647L23.5442 20.3136L23.2953 20.7472C20.3461 25.8841 13.7853 27.6861 8.63821 24.6977C6.21797 23.2925 4.56087 21.092 3.76091 18.6252Z" fill="#6CB771" stroke="#F9F9F9"/>
                    </svg>
                </div>
              </div>
              <svg class="cursor-pointer flex-shrink-0 d-none d-sm-block" width="28" height="32" viewBox="0 0 28 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path class="stroke-lg-white" d="M24.2391 13.3748L21.6723 14.0665C21.0736 12.2561 19.8539 10.6056 18.0624 9.56549C14.1685 7.30467 9.18761 8.6483 6.94116 12.5612L6.69221 12.9948L7.12462 13.2459L8.66607 14.1408L6.56617 14.6718L6.55869 14.6737L6.55127 14.6758L4.2972 15.3209C4.1949 15.3475 4.05814 15.3303 3.92625 15.2537C3.79312 15.1764 3.7096 15.0646 3.6821 14.9614L3.06499 12.6453L2.5082 10.5556L4.02339 11.4353L4.4558 11.6864L4.70474 11.2528C7.65392 6.11587 14.2147 4.31387 19.3618 7.30228C21.782 8.70748 23.4391 10.908 24.2391 13.3748Z" fill="#6CB771" stroke="#F9F9F9"/>
                <path class="stroke-lg-white" d="M3.76091 18.6252L6.32769 17.9335C6.92642 19.7439 8.14609 21.3944 9.93756 22.4345C13.8315 24.6953 18.8124 23.3517 21.0588 19.4388L21.3078 19.0052L20.8754 18.7541L19.3339 17.8592L21.4338 17.3282L21.4413 17.3263L21.4487 17.3242L23.7028 16.6791C23.8051 16.6525 23.9419 16.6697 24.0737 16.7463C24.2069 16.8236 24.2904 16.9354 24.3179 17.0386L24.935 19.3547L25.4918 21.4444L23.9766 20.5647L23.5442 20.3136L23.2953 20.7472C20.3461 25.8841 13.7853 27.6861 8.63821 24.6977C6.21797 23.2925 4.56087 21.092 3.76091 18.6252Z" fill="#6CB771" stroke="#F9F9F9"/>
                </svg>
            </div>
            ...
            <input type="submit" value="ورود و ثبت نام با شماره تلفن"
            ...
            <a
              ...
              <p class="mb-0 text-lg-white text-dark fw-bold fs-14">Sign in with Google</p>
              <img alt="google" :src="require('../assets/img/2991148 1.png')" class="img-fluid">
            </a>
          </form>
        </div>
      </div>
