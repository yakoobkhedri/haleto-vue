      ...
      <div class="mt-4 mb-5 pb-3 px-sm-4 px-3 position-relative">
        ...
        <div class="my-5">
          ...
          <div class="px-sm-4">
            ...
            <div class="d-flex flex-column flex-lg-row align-items-center mt-4 gap-4">
              <div class="rounded-10 p-3 bg-gray flex-grow-1 pb-5 w-100">
                <div class="d-flex align-items-center gap-2">
                  <div
                  ...
                  <p class="mb-0 fw-bold text-dark">بیماران بر اساس سن</p>
                </div>
                <select class="mt-4 bg-white border border-dark d-block w-271 py-2 px-3 mx-auto">
                  <option>فیلتر بازه سنی</option>
                  <option>فیلتر بازه سنی</option>
                  <option>فیلتر بازه سنی</option>
                </select>
                <div class="mt-4"> 
                 <div class="d-flex align-items-center gap-4 text-secondary font-bold mb-3 flex-wrap">
                  <img alt="img" :src="require('../assets/img/image 67.png')" class="d-block w-60 h-60 rounded-circle">
                  <p class="mb-0">سارا احمدی</p>
                  <p class="mb-0">کد ملی:38093422123</p>
                 </div>
                 <div class="d-flex align-items-center gap-4 text-secondary font-bold mb-3 flex-wrap">
                  <img alt="img" :src="require('../assets/img/image 67.png')" class="d-block w-60 h-60 rounded-circle">
                  <p class="mb-0">سارا احمدی</p>
              ...
              <div class="rounded-10 p-3 bg-gray flex-grow-1 pb-5 w-100">
                <div class="d-flex align-items-center gap-2">
                  ...
                  <p class="mb-0 fw-bold text-dark">بیماران بر اساس جنسیت</p>
                </div>
                <select class="mt-4 bg-white border border-dark d-block w-271 py-2 px-3 mx-auto">
                  <option>فیلتر جنسیت</option>
                  <option>فیلتر جنسیت</option>
                  <option>فیلتر جنسیت</option>
                </select>
                <div class="mt-4"> 
