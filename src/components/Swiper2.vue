<template>
     <div class="position-relative mt-5 servicesbox" data-aos="fade-down">
             ...
             <div class="swiper-slide">
               <div class="rounded-12 py-4 overflow-hidden bg-white position-relative">
                <span class="font-bold z-1 shadow fs-12 bg-orange-transparent text-orange d-flex align-items-center justify-content-center w-70 rounded-l-4 h-28 position-absolute top-0 end-0 mt-2">30%-</span>
                 <div class="position-relative mx-5">
                  ...
                  <div class="d-flex align-items-center justify-content-center cursor-pointer w-40 h-40 rounded-circle border position-absolute bottom-0 start-0 bg-white">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <path d="M19.6602 3.99C17.0202 2.19 13.7602 3.03 12.0002 5.09C10.2402 3.03 6.98021 2.18 4.34021 3.99C2.94021 4.95 2.06021 6.57 2.00021 8.28C1.86021 12.16 5.30021 15.27 10.5502 20.04L10.6502 20.13C11.4102 20.82 12.5802 20.82 13.3402 20.12L13.4502 20.02C18.7002 15.26 22.1302 12.15 22.0002 8.27C21.9402 6.57 21.0602 4.95 19.6602 3.99ZM12.1002 18.55L12.0002 18.65L11.9002 18.55C7.14021 14.24 4.00021 11.39 4.00021 8.5C4.00021 6.5 5.50021 5 7.50021 5C9.04021 5 10.5402 5.99 11.0702 7.36H12.9402C13.4602 5.99 14.9602 5 16.5002 5C18.5002 5 20.0002 6.5 20.0002 8.5C20.0002 11.39 16.8602 14.24 12.1002 18.55Z" fill="#263238"/>
                      </g>
                      <defs>
                      <clipPath id="clip0_187_220">
                 ...
                 <div class="d-flex align-items-center gap-3 justify-content-between mx-5 mt-4">
                  <h6 class="fw-bold mb-0 text-second fs-sm-14">خلق مدل کسب و کار</h6>
                 ...
                 <a href="single-book.html" class="d-flex mt-4 mx-5 align-items-center justify-content-center transition text-main fw-bold rounded-8 blogLink h-48">مطالعه بیشتر</a>
               </div>
             </div>
             <div class="swiper-slide">
               <div class="rounded-12 py-4 overflow-hidden bg-white position-relative">
